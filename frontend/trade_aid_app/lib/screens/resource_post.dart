...
class _ResourcePostScreenState extends State<ResourcePostScreen> {
  ...
  Widget _buildDayPicker() {
    ...
    final dayWidth = (screenWidth - 20 * 2 - 6 * 6) / 7;
    return Row(
                  ...
                  children: [
                    Expanded(
                      child: InkWell(
                        ...
                        child: _timeDisplay("Start Time", _startTime),
                      ),
                    ),
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        child: _timeDisplay("End Time", _endTime),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _timeDisplay(String label, TimeOfDay? time) {
    return Container(
