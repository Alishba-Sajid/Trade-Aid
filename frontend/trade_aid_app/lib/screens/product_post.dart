...
class _ProductPostScreenState extends State<ProductPostScreen> {
  ...
  void _submit() async {
    ...
    // ----------------- USING THE FIELDS -----------------
    // Print them for now (simulate API usage)
    print('Product Name: $_productName');
    print('Description: $_description');
    print('Price: $_price');
    print('Duration: $_usedTime');
    print('Condition: $_condition');
    print('Category: $_productCategory');
    print('Uploaded Images: ${_images.where((e) => e != null).length}');
