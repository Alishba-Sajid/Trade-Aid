...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void _onBottomTap(int index) {
    ...
    if (index == 2 || index == 3 || index == 1 || index == 4) {
      // Trigger actions but reset selection back to Home
      switch (index) {
        case 1:
        ...
        case 3:
          Navigator.push(
            ...
            // Reset Home as selected when returning
      ...
      return; // Skip changing _currentIndex permanently
    }

    // Otherwise, update current index normally (Home)
                    ...
                    children: [
                      ...
                      _PremiumPostCard(
                        ...
                        onTap: () {
                          ...
                          Navigator.pushNamed(context, '/product_post').then((_) {
                            // Reset Home after returning
                            setState(() => _currentIndex = 0);
                          });
                        },
                      ),
                      ...
                      _PremiumPostCard(
                        ...
                        onTap: () {
                          Navigator.pop(context);
                          Navigator.pushNamed(context, '/resource_post').then((_) {
                            // Reset Home after returning
                            setState(() => _currentIndex = 0);
                          });
                        },
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Theme(
        data: Theme.of(context).copyWith(
          // splashColor: appGradient.colors[1],
          highlightColor: appGradient.colors[0].withOpacity(0.2),
        ),
